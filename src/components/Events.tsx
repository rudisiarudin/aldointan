...
export const Events: React.FC = () => {
  ...
  return (
    <section className="bg-surface relative" id="events">
      {/* WEDDING DETAILS SECTION */}
      <div className="py-12 md:py-16 px-4 md:px-margin-desktop bg-surface-container-lowest relative min-h-screen flex flex-col justify-center snap-start snap-always">
        ...
        <div className="max-w-5xl mx-auto relative z-10 w-full">
          <div className="text-center mb-10 relative flex justify-center">
            <AnimatedSection delay={0.3} className="relative inline-block">
        ...
        <div className="flex flex-col items-center justify-center w-full max-w-lg mx-auto mb-10">
          ...
          {/* Unified Date Block */}
          <AnimatedSection delay={0.4} className="flex flex-col items-center mb-10">
          ...
          {/* Events Row */}
          <AnimatedSection delay={0.5} className="flex flex-row items-center justify-center w-full relative">
            {/* Akad Nikah */}
        ...
        {/* Location Section */}
        <AnimatedSection delay={0.6} className="max-w-xl mx-auto text-center border-t border-deep-burgundy/10 pt-6 px-4">
      ...
      <div className="bg-[#f7f4ef] py-12 md:py-16 px-4 md:px-margin-desktop relative flex flex-col items-center justify-center min-h-screen snap-start snap-always">
        <div className="max-w-2xl mx-auto relative flex flex-col items-center text-center z-10 w-full">
          
          {/* Decorative Image 18.png */}
          <AnimatedSection delay={0.3} className="mb-6 md:mb-8 w-20 md:w-32 drop-shadow-sm transition-transform duration-700 hover:scale-105">
          ...
          <AnimatedSection delay={0.5} className="flex items-center gap-4 mb-6 md:mb-8">
          ...
          <div className="font-body-main text-[12px] md:text-[15px] leading-relaxed text-deep-burgundy/80 space-y-4 md:space-y-6 max-w-lg mx-auto">
            ...
            <AnimatedSection delay={0.8} className="pt-4 md:pt-6 pb-2">
