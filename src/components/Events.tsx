...
export const Events: React.FC = () => {
  ...
  return (
    <section className="bg-surface relative overflow-hidden" id="events">
      ...
      <div className="py-12 md:py-16 px-4 md:px-margin-desktop bg-surface-container-lowest relative min-h-[100dvh] flex flex-col justify-center overflow-hidden snap-start">
      ...
      <div className="bg-[#f7f4ef] py-12 md:py-16 px-4 md:px-margin-desktop relative flex flex-col items-center justify-center min-h-[100dvh] snap-start">
