...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative w-full bg-white" id="home">
      ...
      <div className="relative z-10 w-full min-h-screen max-w-lg mx-auto flex flex-col items-center text-center px-4 pt-12 md:pt-20 snap-start snap-always">
      ...
      <div className="relative z-10 w-full min-h-screen max-w-lg mx-auto flex flex-col items-center justify-center text-center px-4 py-16 bg-[#FDF8F3] snap-start snap-always">
