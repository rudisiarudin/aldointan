...
export const Profiles: React.FC = () => {
  ...
  return (
    <section className="bg-surface relative pt-16 md:pt-24 pb-12 md:pb-16 overflow-x-hidden min-h-screen flex flex-col justify-center snap-start snap-always" id="profiles">
      <div className="max-w-7xl mx-auto relative flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-8 relative z-10 w-full">
          ...
          {/* Bride Info */}
          <div className="md:col-span-4 flex flex-col items-center md:items-end justify-center w-full order-1 md:order-1 relative">
            {/* Mobile Photo */}
            <AnimatedSection delay={0.3} className="md:hidden w-52 h-64 bg-paper-white shadow-xl p-2 -rotate-3 mb-8 relative border border-deep-burgundy/5">
            ...
            <div className="flex flex-row items-stretch w-full max-w-[280px] text-left relative">
              {/* Vertical Title */}
              <AnimatedSection delay={0.4} className="flex flex-col items-center mr-5 pt-2">
          ...
          {/* Groom Info */}
          <div className="md:col-span-4 flex flex-col items-center md:items-start justify-center w-full order-2 md:order-3 pt-12 md:pt-0 relative">
            {/* Mobile Photo */}
            <AnimatedSection delay={0.4} className="md:hidden w-52 h-64 bg-paper-white shadow-xl p-2 rotate-3 mb-8 relative border border-deep-burgundy/5">
              <div className="w-full h-full relative overflow-hidden">
            ...
            <div className="flex flex-row-reverse items-stretch w-full max-w-[280px] text-right relative">
              {/* Vertical Title */}
              <AnimatedSection delay={0.5} className="flex flex-col items-center ml-5 pt-2">
